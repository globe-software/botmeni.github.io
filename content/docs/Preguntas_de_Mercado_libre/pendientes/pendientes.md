...
{{< figure width="700px" height="500px" src="/images/general/pendientes3.png" >}}
1. En la sección superior se detallan:
{{< figure width="700px" height="500px" src="/images/general/pendientes4.png" >}}
    ...
    5. Subestado: Cada pregunta tiene un subestado. En el caso de la imagen, el subestado señala que la respuesta fue procesada pero no se envió a Botmeni ya que estaba establecido el modo de comportamiento Solo Analizar para la vertical de negocios a la que pertenece el artículo.
2. 
