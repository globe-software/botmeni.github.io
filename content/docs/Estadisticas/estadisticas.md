...
6. El gráfico Sentimiento de preguntas procesadas desplegado a continuación, muestra la ditribución de las preguntas procesadas según el sentimiento que expresa (neutro, positivo o negativo).
{{< figure width="700px" height="500px" src="/images/general/estadistica18.png" >}}
7. El siguiente gráfico detalla la distribución de la calidad de las respuestas generadas para el periodo de tiempo seleccionado. Cada una de las respuestas generadas por nuestra plataforma es evaluada y luego calificada según su calidad en 5 niveles, siendo 5 el nivel de calidad superior. También existe la calidad 0, que hace referencia a las preguntas que tuvieron un comportamiento particular definido por el usuario debido a una característica específica de la pregunta o respuesta (por ejemplo, preguntas sobre stock con comportamiento de respuesta manual debido a que ese fue el comportamiento establecido por la tienda para esa clase de preguntas).
 {{< figure width="700px" height="500px" src="/images/general/estadistica19.png" >}}
8. En la sección Conversión se muestra la conversión (porcentaje de preguntas ingresadas que terminan en venta), diferenciado por tipo de comportamiento de respuesta asociada a la venta (automática o no automática) y por horario (dentro o fuera del horario laboral). Se considera horario laboral a la franja horaria de lunes a viernes de 9 a 18 h.
